...
namespace FlyHigh
{
    public static class BoundingSphereRenderer
    {
        ...
        /// <summary>
        /// Renders a list of bounding spheres using different colors for each axis.
        /// </summary>
        /// <param name="sphere">The sphere to render.</param>
        /// <param name="graphicsDevice">The graphics device to use when rendering.</param>
        /// <param name="view">The current view matrix.</param>
        ...
        /// <param name="xzColor">The color for the XZ circle.</param>
        /// <param name="yzColor">The color for the YZ circle.</param>
        public static void Render(BoundingSphere[] spheres, GraphicsDevice graphicsDevice, Matrix view, Matrix projection, Color xyColor, Color xzColor, Color yzColor)
        {
        ...
        // <summary>
        /// Renders a list of bounding spheres using one  colors for each axis.
        /// </summary>
        /// <param name="sphere">The sphere to render.</param>
        /// <param name="graphicsDevice">The graphics device to use when rendering.</param>
        /// <param name="view">The current view matrix.</param>
        /// <param name="projection">The current projection matrix.</param>
        /// <param name="xyColor">The color for the circle.</param>
        public static void Render(BoundingSphere[] spheres, GraphicsDevice graphicsDevice, Matrix view, Matrix projection, Color color)
        {
            foreach (BoundingSphere sphere in spheres)
            {
        ...
        // Zeichnet die Sphere korrekt, aber verformt sie nicht !!!
        /// <summary>
        /// Renders a bounding ellipse using a single color for all three axis.
        /// </summary>
        /// <param name="sphere">The sphere to render</param>
        /// <param name="scale">Size of the sphere</param>
        /// <param name="quaternion">Rotation of the ellipse</param>
        /// <param name="graphicsDevice">Device</param>
        /// <param name="view">View-Matrix</param>
        /// <param name="projection">Projection-Matrix</param>
        /// <param name="color">Color of the ellipse</param>
        public static void RenderWithVectorScale(BoundingSphere sphere, Vector3 scale, Quaternion quaternion, GraphicsDevice graphicsDevice, Matrix view, Matrix projection, Color color)
        {
            if (vertBuffer == null)
                InitializeGraphics(graphicsDevice, 30);
            ...
            effect.World = Matrix.CreateScale(scale) * Matrix.CreateFromQuaternion(quaternion) * Matrix.CreateTranslation(sphere.Center);
            effect.View = view;
            effect.Projection = projection;
            effect.DiffuseColor = color.ToVector3();
